...
{
    [CreateAssetMenu(fileName = nameof(GraphicsSettings), menuName = "TileGen/Settings/" + nameof(GraphicsSettings))]
    public class GraphicsSettings : ScriptableObject
    {
        ...
        public ExtendedGradient gradient;

        [Header("Water Settings")]
        public Color waterBaseColor = Color.blue;
        public BiomeDataSettings seaBiomeData;

        public BiomeDataSettings GetBiomeData(float time)
		{
