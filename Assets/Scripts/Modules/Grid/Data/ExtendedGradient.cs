...
{
    [CreateAssetMenu(fileName = nameof(ExtendedGradient), menuName = "TileGen/Settings/" + nameof(ExtendedGradient))]
    public class ExtendedGradient : ScriptableObject
    {
        ...
        public int AddKey(BiomeDataSettings data, float time)
        {
        ...
        public void UpdateKeyColour(BiomeDataSettings biomeData, int index)
        {
        ...
        public void SetKeyData(int i, BiomeDataSettings biomeData)
        {
        ...
        public struct BiomeKey
        {
            ...
            public BiomeKey(BiomeDataSettings biomeData, float time, Color color)
            {
