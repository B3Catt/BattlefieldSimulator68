...
public class UnitTest : MonoBehaviour
{
	...
	public int getMoveTime(HexPosition pos) {
		//First we return a negative number if that position isn't traversable. We could look for other things, or check if it's on the board.
		if(pos.containsKey("Obstacle"))
			return -1;
		//Next, we return how many spaces it costs to cross that. If you want it to take twice as long to cross a certain terrain, you'd have to use 2.
		//And if you want it to take half as long, then you make everything else use 2. Or you change everything to use doubles instead of ints.
		return 1;
	}
